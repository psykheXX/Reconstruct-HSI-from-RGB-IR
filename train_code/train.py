...
parser.add_argument("--data_root", type=str, default='D:/potato_hyper_dataset/')
...
# load dataset
print("\nloading dataset ...")
train_data = TrainDataset(data_root=opt.data_root, crop_size=opt.patch_size, bgr2rgb=False, arg=True, stride=opt.stride)
