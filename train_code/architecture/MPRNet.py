...
class SAM(nn.Module):
    def __init__(self, n_feat, kernel_size, bias):
        ...
        self.conv2 = conv(n_feat, 36, kernel_size, bias=bias)
        self.conv3 = conv(36, n_feat, kernel_size, bias=bias)
...
class MPRNet(nn.Module):
    def __init__(self, in_c=36, out_c=36, n_feat=36, scale_unetfeats=36, scale_orsnetfeats=36, num_cab=4, kernel_size=3, reduction=1, bias=False):
